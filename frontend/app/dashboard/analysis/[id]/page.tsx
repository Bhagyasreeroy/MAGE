...
export default function AnalysisResultPage() {
  ...
  async function handleSendMessage(e: React.FormEvent) {
    ...
    try {
      ...
      // What "no recommendations" means is worth spelling out. The knowledge
      // base is EDA *methodology*, so a question about a particular record
      // ("tell me about Drake") has nothing in it to ground against — and the
      // honest answer is to say so and point at the tool that can, rather than
      // return the nearest methodology document and let it read as an answer.
      const reply =
